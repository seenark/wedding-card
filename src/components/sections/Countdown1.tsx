...
export default component$<Props>(({ weddingDate }) => {
  ...
  return (
    <div class="flex justify-center items-center w-full h-full">
      <div class="w-[300px] bg-transparent border-2 border-white rounded-xl drop-shadow-10px-solid flex flex-col justify-center items-center p-4 text-white">
        <h2 class="uppercase font-bold text-[24px]">count down to</h2>
        <h2 class="uppercase font-bold text-[24px]">the wedding day</h2>
        <div class="p-4 flex flex-col gap-4 text-[70px] font-black">
          <div class="py-2 px-4 bg-teal-900 shadow-4px-solid flex flex-col items-center justify-center">
        ...
        <div class="flex flex-row gap-2">
          <div class="flex flex-col justify-center items-center p-2 bg-teal-900 shadow-4px-solid">
